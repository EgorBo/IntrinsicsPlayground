...
namespace IntrinsicsPlayground
{
    public class ArrayIsSorted
    {
        ...
        public void GlobalSetup()
        {
            ...
            _testArray = Enumerable.Range(0, count).ToArray();
        }

        [Benchmark]
        public bool IsSorted_Simple()
        {
            return IsSorted_Simple(_testArray);
        }

        [Benchmark]
        public bool IsSorted_Simple2()
        {
            return IsSorted_Simple2(_testArray);
        }

        [Benchmark]
        public bool IsSorted_Sse41()
        {
            return IsSorted_Sse41(_testArray);
        }

        [Benchmark(Baseline = true)]
        public bool IsSorted_AVX2()
        {
            return IsSorted_AVX2(_testArray);
        }
